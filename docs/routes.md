...
| [/aphasia-describe-the-city-you-live-in](https://www.jiaqiliu.com/aphasia-describe-the-city-you-live-in) | `aphasia-describe-the-city-you-live-in/index.html` | `aphasia-describe-the-city-you-live-in` | sitemap | Verified locally; gallery with local lightbox |
...
| [/film-pd-art-direction](https://www.jiaqiliu.com/film-pd-art-direction) | `film-pd-art-direction/index.html` | `film-pd-art-direction` | sitemap | Verified locally; linked gallery |
...
| [/hydrogen-balloon](https://www.jiaqiliu.com/hydrogen-balloon) | `hydrogen-balloon/index.html` | `hydrogen-balloon` | sitemap | Verified locally; gallery with local lightbox |
...
| [/museum-guard-tutorial](https://www.jiaqiliu.com/museum-guard-tutorial) | `museum-guard-tutorial/index.html` | `museum-guard-tutorial` | sitemap | Verified locally; gallery with local lightbox |
| [/oblivio](https://www.jiaqiliu.com/oblivio) | `oblivio/index.html` | `oblivio` | sitemap | Verified locally; gallery with local lightbox |
...
| [/the-ninth-marriage](https://www.jiaqiliu.com/the-ninth-marriage) | `the-ninth-marriage/index.html` | `the-ninth-marriage` | sitemap | Verified locally; gallery with local lightbox |

## Responsive layouts

The 17 gallery configurations retain their captured desktop/mobile column counts, gaps, crop ratios, and caption padding. The generated `source-layout.css` preserves the existing 750/751px breakpoint. Original page CSS and source DOM preserve other intentional page differences.
